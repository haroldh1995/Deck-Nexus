...
function normalizeCard(card: SnapshotDeckCard): SnapshotCardEntry {
  ...
  return {
    ...
    language: card.printingSelection.language,
    foil: card.printingSelection.finish === "foil",
    finish: card.printingSelection.finish,
    condition: card.printingSelection.condition,
