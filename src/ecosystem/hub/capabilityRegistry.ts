...
export function getHubCapabilityRegistry(settings?: AppSettings): HubCapabilityContract[] {
  ...
  return [
    ...
    capability("collection", "Collection", "Owned cards and imported collection data remain local-first.", {
      supported: true,
      configured: true,
      verified: true,
      available: true,
  ...
  return [
    {
      ...
      label: "Deck Nexus",
      status: "Active",
      capability: "Decks, collection imports, search, analytics, snapshots",
      availability: "Local",
    ...
    },
    {
      ...
      capability: "Appearance, accessibility, import and backup preferences",
