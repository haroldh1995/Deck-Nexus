...
import { summarizeCollectionValue } from "../../collector";
import type {
  AppSettings,
  CommanderColor,
  Deck,
...
function mapOwnedPrinting(
  ...
  return {
    ...
    priceUpdatedAt: printing.priceUpdatedAt,
    manualPriceOverride: printing.manualPriceOverride,
    tradeStatus: printing.tradeStatus,
    storageLocation: printing.storageLocation,
    storage: printing.storage,
    collectorFlags: printing.collectorFlags,
...
export function mapOwnedCard(card: OwnedCard): SnapshotOwnedCard {
  return {
    ...
    manualPriceOverride: card.manualPriceOverride,
    tradeStatus: card.tradeStatus,
    wantStatus: card.wantStatus,
    tags: card.tags,
    notes: card.notes,
    favorite: card.favorite,
    storageLocation: card.storageLocation,
    storage: card.storage,
    collectorFlags: card.collectorFlags,
    rarity: card.rarity,
...
export function createCollectionSnapshot(
  ...
  const snapshot: CollectionSnapshot = {
    ...
    statistics: {
      ...
      estimatedValue: summarizeCollectionValue(ownedCards),
    },
...
export function createProfileSnapshot(
  ...
  return withChecksum({
    ...
    applicationPreferences: {
      ...
      collectorCurrency: settings.collectorCurrency,
      collectorHighValueThreshold: settings.collectorHighValueThreshold,
      collectorPriceFreshnessDays: settings.collectorPriceFreshnessDays,
